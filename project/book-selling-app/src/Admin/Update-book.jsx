...
export default function Updatebook() {
    ...
    useEffect(() => {
        axios.get(`http://localhost:1200/books/${id}`)
            .then((res) => {
                setBooks(res.data)
            })
    }, [])
    ...
    const UpdateBook = () => {
        ...
        axios.put(`http://localhost:1200/books/${id}`, update)
            .then(() => {
                Swal.fire({
                    icon: 'success',
                    title: 'Book',
        ...
        <div>
            ...
            <Container className='p-5'>
                <form>
                    ...
                    <div className="form-floating mt-3">
                        <Button variant='outline-success' className='w-100' onClick={UpdateBook}>Update Book</Button>
                    </div>
                </form>
            </Container>
            <Footer />
